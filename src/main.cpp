...
void Waifu2xWrapper::setNoise(int p_noise) {
    this->noise=p_noise;
}

void Waifu2xWrapper::setScale(int p_scale) {
    this->scale=p_scale;
}
...
void Waifu2xWrapper::setGpu(std::vector<int> gpu) {
    this->gpuid=std::move(gpu);
}

void Waifu2xWrapper::setJobsLoad(int load) {
    jobs_load=load;
}

void Waifu2xWrapper::setJobProc(std::vector<int> proc) {
    jobs_proc=std::move(proc);
}

void Waifu2xWrapper::setJobSave(int save) {
    jobs_save=save;
}

void Waifu2xWrapper::setTtaMode(int mode) {
    tta_mode=mode;
}
